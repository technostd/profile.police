...
CheckUpdate()
{
    ...
    Gui 4:Show,, AHK ГУ МВД #5 | AHK Province
    Return
...
RefreshTray() ; Трэй
{
TrayTip, AHK ГУ МВД #5 (%GuiVersion%), Скрипт успешно запущен.
IM = %WorkingDir%\ahk.ico
IfExist, %IM%
Menu, Tray, Icon, %IM%
...
Menu, Tray, Tip, AHK ГУ МВД #5 (%GuiVersion%)
Return
...
Gui 1:Add, Text, xp yp+20 w100 h20, /убор
Gui 1:Add, Text, xp yp+20 w100 h20, /маска
Gui 1:Add, Text, xp yp+20 w100 h20, /шлем
Gui 1:Add, Text, xp yp+20 w100 h20, /очки
...
Gui 1:Add, Text, xp yp+20 w170 h20, Снять головной убор
Gui 1:Add, Text, xp yp+20 w170 h20, Снять маску
Gui 1:Add, Text, xp yp+20 w170 h20, Снять шлем
Gui 1:Add, Text, xp yp+20 w170 h20, Снять очки
...
Gui 1:Add, Text, xp+290 yp w280 r20, Для всех статей УК из глав №№ 2, 4-7 предусмотрена команда вида /укX.Y, где X.Y - номер статьи`n`nВыдает только расшифровку статьи.

Gui 1:Font, s16 c000000 
Gui 1:Tab, 3
Gui 1:Add, GroupBox, x010 y40 w870 h650, [ Рация ]
Gui 1:Font, Bold C540000 s10
Gui 1:Add, Text, x015 y072 w200 h20, /патр<+/п/->
Gui 1:Add, Text, xp yp+20 w200 h20, /патрн<+/п/-> <звание Фамилия>
Gui 1:Add, Text, xp yp+20 w200 h20, /пост<+/п/-> <Название поста>
Gui 1:Add, Text, xp yp+20 w200 h20, /пппсн
...
Gui 1:Add, Text, xp yp+20 w200 h20, /экипаж <Местоположение>
...
Gui 1:Add, Text, x215 y072 w500 h20, Выехал/продолжаю/закончил патрулирование
Gui 1:Add, Text, xp yp+20 w500 h20, Выехал/продолжаю/закончил патрулирование с напарником звание Фамилия
Gui 1:Add, Text, xp yp+20 w500 h20, Заступил/продолжаю/сдал дежурство на посту Название поста
Gui 1:Add, Text, xp yp+20 w500 h20, Принять вызов от ГУ МВД-Н
...
Gui 1:Add, Text, xp yp+20 w500 h20, Вызвать экипаж ДПС к <Местоположение>
Gui 1:Add, Text, xp yp+20 w500 h20, Вызвать экипаж ДПС к ДЧ г. Невский
Gui 1:Add, Text, xp yp+20 w500 h20, Вызвать экипаж ДПС к ДЧ г. Мирный
Gui 1:Add, Text, xp yp+20 w500 h20, Вызвать экипаж ДПС к ДЧ г. Приволжск
...
Gui 1:Font, s16 c000000 
Gui 1:Tab, 4
Gui 1:Add, GroupBox, x010 y40 w870 h650, [ Первая медицинская помощь ]

Gui 1:Font, Bold C540000 s10
Gui 1:Add, Text, x015 y072 w200 h20, /аптечка+
Gui 1:Add, Text, xp yp+20 w200 h20, /чтослуч
Gui 1:Add, Text, xp yp+20 w200 h20, /пульс
Gui 1:Add, Text, xp yp+20 w200 h20, /реаним
Gui 1:Add, Text, xp yp+20 w200 h20, /нашатырь
Gui 1:Add, Text, xp yp+20 w200 h20, /осмотр
Gui 1:Add, Text, xp yp+20 w200 h20, /дезинф
Gui 1:Add, Text, xp yp+20 w200 h20, /повязка
Gui 1:Add, Text, xp yp+20 w200 h20, /жгут
Gui 1:Add, Text, xp yp+20 w200 h20, /пальпация
Gui 1:Add, Text, xp yp+20 w200 h20, /йод
Gui 1:Add, Text, xp yp+20 w200 h20, /шина
Gui 1:Add, Text, xp yp+20 w200 h20, /ушиб
Gui 1:Add, Text, xp yp+20 w200 h20, /аптечка-

Gui 1:Font, c000000
Gui 1:Add, Text, xp yp+20 w500 h20, Хочешь помочь с дополнением? Пиши свои пожелания - t.me/provinceahk
Gui 1:Add, Text, x215 y072 w500 h20, Достать аптечку из багажника
Gui 1:Add, Text, xp yp+20 w500 h20, Узнать, что случилось
Gui 1:Add, Text, xp yp+20 w500 h20, Проверить пульс
Gui 1:Add, Text, xp yp+20 w500 h20, Провести сердечно-лёгочную реанимацию
Gui 1:Add, Text, xp yp+20 w500 h20, Привести в сознание нашатырным спиртом
Gui 1:Add, Text, xp yp+20 w500 h20, Провести осмотр пострадавшего
Gui 1:Add, Text, xp yp+20 w500 h20, Дезинфицировать рану
Gui 1:Add, Text, xp yp+20 w500 h20, Наложить давящую повязку (венозное кровотечение)
Gui 1:Add, Text, xp yp+20 w500 h20, Наложить жгут (артериальное кровотечение)
Gui 1:Add, Text, xp yp+20 w500 h20, Пальпировать место предполагаемого перелома
Gui 1:Add, Text, xp yp+20 w500 h20, Обработать йодом
Gui 1:Add, Text, xp yp+20 w500 h20, Наложить воздушную шину
Gui 1:Add, Text, xp yp+20 w500 h20, Компресс с гепариновой мазью, повязка (ушиб) 
Gui 1:Add, Text, xp yp+20 w500 h20, Убрать аптечку в багажник автомобиля
...
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-0-1", "0")
GoSub RadioOff
Return
...
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-0-2 Код-3. ", "0")
GoSub RadioOff
Return
...
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-0-3 Код-3. ", "0")
GoSub RadioOff
Return

:?:/патрн+::
GetArgsForHotstring("патрн+", "Place")
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-0-1 Напарник: " Place, "0")
GoSub RadioOff
Return

:?:/патрнп::
GetArgsForHotstring("патрнп", "Place")
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-0-2 Код-3. Напарник: " Place, "0")
GoSub RadioOff
Return
...
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-0-3 Код-3. Напарник: " Place, "0")
GoSub RadioOff
Return

:?:/пост+::
GetArgsForHotstring("пост+", "Place")
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-1-1 Пост: " Place, "0")
GoSub RadioOff
Return

:?:/постп::
GetArgsForHotstring("постп", "Place")
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-1-2 Код-3. Пост: " Place, "0")
GoSub RadioOff
Return
...
SendPlay {Enter}
GoSub RadioOn
SendChat("r " Departmentcode "-" Tencode " 10-1-3 Код-3. Пост: " Place, "0")
GoSub RadioOff
Return
...
:?:/аптечка+::
SendPlay {Enter}
SendChat("do Аптечка в багажнике.", "500")
SendChat("me достал аптечку из багажника", "0")
Return

:?:/чтослуч::
SendPlay {Enter}
SendChat("do Аптечка в руках.", "500")
SendChat("me поставил аптечку на землю и открыл её", "500")
SendChat("me достал из аптечки чистые нитриловые перчатки и надел их", "500")
SendChat("do Что случилось с пострадавшим?", "500")
SendChat("b Напишите в чат через команду /do, что с вами случилось", "500")
SendChat("b Пример: /do Пострадавшего сбила машина.", "0")
Return

:?:/пульс::
SendPlay {Enter}
SendChat("me поднес руку к сонной артерии пациента", "500")
SendChat("do Рука поднесена к сонной артерии пациента.", "500")
SendChat("do Пульс обнаружен?", "500")
SendChat("b Ответьте РП отыгровкой в чат: /do Да. или /do Нет.", "500")
SendChat("b Чат открывается на клавишу F6 и туда прописываются эти команды.", "0")
Return

:?:/реаним::
SendPlay {Enter}
SendChat("me провёл непрямой массаж сердца пострадавшему, надавливая на грудную клетку", "500")
SendChat("do Сотрудник выполняет непрямой массаж сердца.", "500")
SendChat("me прислонил руку к сонной артерии пациента", "500")
SendChat("do Пульс обнаружен.", "500")
SendChat("b Ответьте РП отыгровкой в чат: /do Да. или /do Нет.", "0")
Return

:?:/нашатырь::
SendPlay {Enter}
SendChat("me достал спирт и вату из аптечки", "500")
SendChat("me смочив ватку нашатырным спиртом, провел ею около носа пострадавшего", "500")
SendChat("me откинув использованный кусочек ваты на землю, поставил спирт в аптечку", "500")
SendChat("do Нашатырный спирт в аптечке.", "500")
SendChat("do Пострадавший пришел в сознание?", "500")
SendChat("b Ответьте РП отыгровкой в чат: /do Да. или /do Нет.", "0")
Return

:?:/осмотр::
SendPlay {Enter}
SendChat("me начал осматривать тело пострадавшего", "500")
SendChat("do Сотрудник осматривает всё тело пострадавшего.", "500")
SendChat("do Какие ранения и травмы имеются на теле?", "500")
SendChat("b Ответьте РП отыгровкой /do в чат. Можете написать про ссадины, порезы, ушибы.", "0")
Return

:?:/аптечка-::
SendPlay {Enter}
SendChat("me снял нитриловые перчатки и убрал их в карман", "500")
SendChat("me убрал аптечку в багажник автомобиля", "0")
Return

:?:/дезинф::
SendPlay {Enter}
SendChat("do В аптечке лежит спрей 'Хлоргексидин'.", "500")
SendChat("me достал из аптечки спрей 'Хлоргексидин'", "500")
SendChat("me нанес препарат на место ранения", "500")
SendChat("me убрал спрей в сумку", "0")
Return

:?:/повязка::
SendPlay {Enter}
SendChat("do В аптечке лежат бинты.", "500")
SendChat("me достал две упаковки бинтов", "500")
SendChat("me открыв бинты, отбросил упаковку на землю", "500")
SendChat("me приложил один валик к месту ранения", "500")
SendChat("me размотав второй валик бинта, наложил его на место ранения", "500")
SendChat("do Давящая повязка наложена.", "0")
Return

:?:/жгут::
SendPlay {Enter}
SendChat("do В аптечке лежат жгут, шприц с обезболивающим, ватка и медицинский спирт.", "500")
SendChat("me открыл аптечку и достал из нее жгут", "500")
SendChat("me развязав жгут, надел его чуть выше пулевого отверстия", "500")
SendChat("me затянул ремешок жгута", "500")
SendChat("do Жгут затянут.", "0")
Return

:?:/пальпация::
SendPlay {Enter}
SendChat("me начал слегка нажимать на место примерного перелома на конечностях", "500")
SendChat("do Сотрудник проводит пальпацию.", "500")
SendChat("do Какая часть тела сломана?", "0")
Return

:?:/йод::
SendPlay {Enter}
SendChat("do В аптечке лежат жгут, вата, спиртовой раствор йода и шина.", "500")
SendChat("me открыл аптечку и достал из нее жгут", "500")
SendChat("me наложил жгут выше раны пострадавшего", "500")
SendChat("me достал из медицинской сумки вату и спиртовой раствор йода", "500")
SendChat("me смочил ватку йодом", "500")
SendChat("me обработал рану ватой", "500")
SendChat("do Рана обработана.", "0")
Return

:?:/шина::
SendPlay {Enter}
SendChat("do В багажнике лежит насос и вакуумные шины.", "500")
SendChat("me взял шину с насосом", "500")
SendChat("me держа шину в руке, вставил в неё насос", "500")
SendChat("me наложил шину на примерное место перелома", "500")
SendChat("me накачал шину насосом", "500")
SendChat("me вытащил насос из шины", "500")
SendChat("me убрал насос в багажник", "500")
SendChat("do Насос лежит в багажнике.", "0")
Return

:?:/компресс::
SendPlay {Enter}
SendChat("do В аптечке лежат шина, бинт и холодный компресс.", "500")
SendChat("me вытащил из аптечки шину и бинт", "500")
SendChat("me застегнул шину на поврежденной конечности пострадавшего", "500")
SendChat("do Шина застегнута.", "500")
SendChat("me достал из медицинской сумки холодный компресс", "500")
SendChat("me приложил компресс к поврежденной конечности пострадавшего", "500")
SendChat("do Компрессор наложен.", "0")
Return

:?:/гепарин::
SendPlay {Enter}
SendChat("do В аптечке лежат холодный компресс, гепариновая мазь и бинт.", "500")
SendChat("me открыл аптечку и достал из нее холодный компресс", "500")
SendChat("me приложил компресс к месту ушиба пострадавшего", "500")
SendChat("me достал из аптечки гепариновую мазь", "500")
SendChat("me намазал место ушиба гепариновой мазью", "500")
SendChat("me достал из аптечки бинт", "500")
SendChat("me наложил повязку на место ушиба", "500")
SendChat("do Повязка наложена.", "0")
Return
...
:?:/ук2.3::
SendPlay {Enter}
SendChat("say 2.3 УК: Соучастие в совершении уголовного преступления, предусмотренного настоящим Кодексом, прикрывательство,...", "0")
SendChat("say укрывательство преступника, является наказуемыми влечет такую же ответственность, которая бы наступала в случае...", "500")
SendChat("say ...самостоятельного совершения преступления.", "500")
Return

:?:/ук2.5::
SendPlay {Enter}
SendChat("say 2.5 УК: Нелегальные предметы, обнаруженные у задержанного, подлежат конфискации:", "0")
SendChat("say Огнестрельное оружие, патроны, наркотические средства, предметы, которые потенциально могут нанести вред,...", "500")
SendChat("say ... маскировочная маска (балаклава), отмычки.", "500")
Return

:?:/ук4.1::
SendPlay {Enter}
SendChat("say 4.1 УК: Умышленное причинение вреда здоровью человека без летального исхода. Арест сроком на 1 год.", "0")
Return

:?:/ук4.2::
SendPlay {Enter}
SendChat("say 4.2 УК: Умышленное нанесение особо тяжких телесных повреждений, по итогу которых человек...", "0")
SendChat("say ...был доведен до предсмертного положения. Арест сроком на 2 года.", "500")
Return

:?:/ук4.2.1::
SendPlay {Enter}
SendChat("say 4.2.1 УК: Умышленное нанесение особо тяжких телесных повреждений двум или более лицам. Арест сроком от 4 до 6 лет.", "0")
Return

:?:/ук4.2.2::
SendPlay {Enter}
SendChat("say 4.2.2 УК: Нанесение особо тяжких телесных повреждений по неосторожности или совершенное в состоянии аффекта,...", "0")
SendChat("say ...вызванного насилием, издевательством или тяжким оскорблением со стороны потерпевшего...", "500")
SendChat("say ...либо иными противоправными или аморальными действиями (бездействием) потерпевшего. Арест сроком до 2 лет.", "500")
Return

:?:/ук4.3::
SendPlay {Enter}
SendChat("say 4.3 УК: Угроза нанесения особо тяжких телесных повреждений или причинения вреда здоровью человека. Арест сроком на 1 год.", "0")
Return

:?:/ук4.4::
SendPlay {Enter}
SendChat("say 4.4 УК: Похищение гражданина, а также незаконное лишение человека свободы, не связанное с похищением. Арест сроком от 4 до 6 лет.", "0")
Return

:?:/ук4.5::
SendPlay {Enter}
SendChat("say 4.5 УК: Любые действия, явно направленные против половой неприкосновенности и половой свободы личности. Арест сроком от 3 до 6 лет.", "0")
Return

:?:/ук4.6::
SendPlay {Enter}
SendChat("say 4.6 УК: Незаконный сбор или распространение сведений о частной жизни лица, составляющих его личную...", "0")
SendChat("say ...или семейную тайну, без его согласия. Штраф - 30.000 рублей или арест сроком на 1 год.", "500")
Return

:?:/ук5.1::
SendPlay {Enter}
SendChat("say 5.1 УК: Получение должностным лицом взятки в виде денег или другого имущества, прав или услуг имущественного характера...", "0")
SendChat("say ...за осуществление очевидно незаконных действий (бездействия). Штраф в полуторакратном размере...", "500")
SendChat("say ...от полученной взятки в случае её получения в виде денег или другого имущества, а также в размере 50.000 рублей в случае её получения...", "500")
SendChat("say ...в виде прав или услуг имущественного характера, а также арест сроком на 3 года.", "500")
Return

:?:/ук5.2::
SendPlay {Enter}
SendChat("say 5.2 УК: Дача взятки должностному лицу лично или через посредника, равно как и попытка дачи взятки. Арест сроком на 3 года.", "0")
Return

:?:/ук5.3::
SendPlay {Enter}
SendChat("say 5.3 УК: Посягательство на жизнь и здоровье сотрудника полиции, военнослужащего или работника инкассации. Арест сроком от 3 до 6 лет.", "0")
Return

:?:/ук5.4::
SendPlay {Enter}
SendChat("say 5.4 УК: Применение насилия, не опасного для жизни или здоровья, либо угроза применения насилия в отношении представителя власти...", "0")
SendChat("say ...или его близких в связи с исполнением им своих должностных обязанностей. Арест сроком до 3 лет.", "500")
Return

:?:/ук5.5::
SendPlay {Enter}
SendChat("say 5.5 УК: Хамство, борзость, дерзость по отношению к сотруднику правоохранительных органов. Штраф - 15.000 рублей или арест сроком на 1 год.", "0")
Return

:?:/ук5.6::
SendPlay {Enter}
SendChat("say 5.6 УК: Публичное оскорбление или неоднократное проявление неуважения к представителям власти при исполнении ими...", "0")
SendChat("say ...своих должностных обязанностей или в связи с их исполнением. Штраф - 25.000 рублей или арест сроком на 2 года.", "500")
Return

:?:/ук5.7::
SendPlay {Enter}
SendChat("say 5.7 УК: Провокационные действия в отношении сотрудников государственных структур, несущие в себе негативный характер,...", "0")
SendChat("say ...либо развлекательную деятельность. Штраф - 50.000 рублей или арест сроком до 2 лет.", "500")
Return

:?:/ук5.7.1::
SendPlay {Enter}
SendChat("say 5.7.1 УК: Длительное преследование экипажа сотрудников правоохранительных органов и/или всяческое создание помех работе...", "0")
SendChat("say ...сотрудников правоохранительных органов. Штраф - 50.000 рублей или арест сроком до 2 лет.", "500")
Return

:?:/ук5.8::
SendPlay {Enter}
SendChat("say 5.8 УК: Неоднократное неповиновение законному распоряжению или требованию служащего полиции, либо военнослужащего, в связи с исполнением...", "0")
SendChat("say ...ими обязанностей по охране общественного порядка и обеспечению общественной безопасности,...", "500")
SendChat("say ...равно как воспрепятствование исполнению ими служебных обязанностей. Арест сроком на 2 года.", "500")
Return

:?:/ук5.8.1::
SendPlay {Enter}
SendChat("say 5.8.1 УК: Уход от правоохранительных органов, сопутствующий нанесение ущерба имуществу гражданским лицам,...", "0")
SendChat("say ...частным предприятиям и муниципальным предприятиям. Арест сроком на 3 года.", "500")
Return

:?:/ук5.8.2::
SendPlay {Enter}
SendChat("say 5.8.2 УК: Уход от правоохранительных органов, сопутствующий причинением телесных повреждений средней и выше тяжести...", "0")
SendChat("say ...по отношению к гражданскому лицу. Арест сроком на 4 года.", "500")
Return

:?:/ук5.9::
SendPlay {Enter}
SendChat("say 5.9 УК: Умышленное уничтожение, повреждение имущества правоохранительных и прочих государственных организаций...", "0")
SendChat("say ...Штраф - 50.000 рублей или арест сроком на 2 года.", "500")
Return

:?:/ук5.10::
SendPlay {Enter}
SendChat("say 5.10 УК: Заведомо ложный донос о совершении преступления или ложные свидетельские показания по уголовному, административному делу...", "0")
SendChat("say ...Штраф - 25.000 рублей или арест сроком на 2 года.", "500")
Return

:?:/ук5.11::
SendPlay {Enter}
SendChat("say 5.10 УК: Разглашение секретных данных или любых сведений о предстоящих операциях, именах, должностях...", "0")
SendChat("say ...и занимаемых постах служащих государственных организаций. Арест сроком до 3 лет.", "500")
Return

:?:/ук5.12::
SendPlay {Enter}
SendChat("say 5.10 УК: Представление себя в качестве служащего государственной организации, если это не соответствует действительности...", "0")
SendChat("say ...Штраф - 30.000 рублей или арест сроком на 1 год.", "500")
Return

:?:/ук5.13::
SendPlay {Enter}
SendChat("say 5.10 УК: Халатность, то есть неисполнение или ненадлежащее исполнение должностным лицом своих обязанностей вследствие недобросовестного...", "0")
SendChat("say ...или небрежного отношения к службе либо обязанностей по должности, если это повлекло причинение крупного ущерба...", "500")
SendChat("say ...или существенное нарушение прав и законных интересов граждан или организаций. Арест сроком до 3 лет.", "500")
Return

:?:/ук6.1::
SendPlay {Enter}
SendChat("say 6.1 УК: Терроризм, то есть совершение взрыва, поджога или иных действий, устрашающих население и создающих опасность гибели человека,...", "0")
SendChat("say ...причинения значительного имущественного ущерба либо наступления иных тяжких последствий в целях дестабилизации деятельности...", "500")
SendChat("say ...органов власти, либо воздействия на принятие ими решений, а также угроза совершения указанных действий...", "500")
SendChat("say ...в целях воздействия на принятие решений органами власти. Арест сроком до 6 лет.", "500")
Return

:?:/ук6.2::
SendPlay {Enter}
SendChat("say 6.2 УК: Заведомо ложное сообщение о готовящихся взрыве, поджоге или иных действиях, создающих опасность гибели людей, причинения...", "0")
SendChat("say ...значительного имущественногоущерба либо наступления иных общественно опасных последствий...", "500")
SendChat("say ...Штраф - 50.000 рублей, а также арест сроком на 3 года.", "500")
Return

:?:/ук6.3::
SendPlay {Enter}
SendChat("say 6.3 УК: Захват или удержание лица в качестве заложника, совершенные в целях понуждения государства, организации или гражданина...", "0")
SendChat("say ...совершить какое-либо действие или воздержаться от совершения какого-либо действия как условия освобождения заложника...", "500")
SendChat("say ...Арест сроком до 3 лет.", "500")
Return

:?:/ук6.4::
SendPlay {Enter}
SendChat("say 6.4 УК: Организация массовых беспорядков, равно участие в них, сопровождавшихся насилием, погромами, поджогами, уничтожением имущества,...", "0")
SendChat("say ...применением оружия, взрывных устройств, отравляющих либо иных веществ и предметов, представляющих опасность для окружающих....", "500")
SendChat("say ...Штраф — 100.000 рублей и арест сроком до 6 лет.", "500")
Return

:?:/ук6.5::
SendPlay {Enter}
SendChat("say 6.5 УК: Создание устойчивой группы людей в целях нападения на граждан или организации, равно как и руководство такой группой (бандой)...", "0")
SendChat("say ...или участие в его деятельности. Арест сроком до 6 лет.", "500")
Return

:?:/ук6.6::
SendPlay {Enter}
SendChat("say 6.6 УК: Вандализм, то есть осквернение зданий или иных сооружений, порча имущества на общественном транспорте или в иных общественных местах...", "0")
SendChat("say ...Штраф - 10.000 рублей, а также арест сроком на 1 год.", "500")
Return

:?:/ук6.7::
SendPlay {Enter}
SendChat("say 6.7 УК: Незаконное проникновение в жилище, частную территорию либо иной объект, не принадлежащий проникшему лицу,...", "0")
SendChat("say ...совершенное против воли проживающего в нем лица. Арест сроком на 2 года.", "500")
Return

:?:/ук6.8::
SendPlay {Enter}
SendChat("say 6.8 УК: Самовольное проникновение на охраняемый в установленном порядке объект. Штраф - 10.000 рублей или арест сроком на 2 года.", "0")
Return

:?:/ук6.9::
SendPlay {Enter}
SendChat("say 6.9 УК: Приобретение, передача, сбыт, хранение, перевозка, продажа, использование или ношение огнестрельного оружия, его основных частей,...", "0")
SendChat("say ...боеприпасов. Штраф - 20.000 рублей, а также арест сроком на 3 года.", "500")
Return

:?:/ук6.10::
SendPlay {Enter}
SendChat("say 6.10 УК: Незаконные приобретение, хранение, перевозка, изготовление, переработка, продажа наркотических средств, психотропных веществ...", "0")
SendChat("say ...или их аналогов с любой целью. Штраф - 20.000 рублей, а также арест сроком на 3 года.", "500")
Return

:?:/ук6.11::
SendPlay {Enter}
SendChat("say 6.11 УК: Неоказание первой или медицинской помощи больному без уважительных причин лицом, обязанным ее оказывать в соответствии с...", "0")
SendChat("say ...законодательством. Арест сроком на 1 год.", "500")
Return

:?:/ук6.12::
SendPlay {Enter}
SendChat("say 6.12 УК: Попытка срыва мероприятий группой лиц или намеренная помеха в проведении мероприятий. Арест сроком на 3 года.", "0")
Return

:?:/ук6.13::
SendPlay {Enter}
SendChat("say 6.13 УК: Использование не зарегистрированной лицензии и(или) подделка удостоверения или иного официального документа, предоставляющего...", "0")
SendChat("say ...права или освобождающего от обязанностей, в целях его использования либо сбыт такого документа и(или) лицензии...", "500")
SendChat("say ...Штраф - 20.000 рублей, а также арест сроком на 3 года.", "500")
Return

:?:/ук6.14::
SendPlay {Enter}
SendChat("say 6.14 УК: Превышение должностных полномочий. Совершение должностным лицом действий, явно выходящих за пределы его полномочий и...", "0")
SendChat("say ...повлекших существенное нарушение прав и законных интересов граждан или организаций либо охраняемых законом интересов...", "500")
SendChat("say ...общества или государства. Штраф - до 50.000 рублей или арест сроком до 3 лет.", "500")
Return

:?:/ук7.1::
SendPlay {Enter}
SendChat("say 7.1 УК: Мошенничество, то есть хищение чужого имущества или приобретение права на чужое имущество путем обмана или злоупотребления доверием...", "0")
SendChat("say ...Штраф - 50.000 рублей и возмещение ущерба или арест сроком на 3 года.", "500")
Return

:?:/ук7.2::
SendPlay {Enter}
SendChat("say 7.2 УК: Грабеж или кража чужого имущества. Арест сроком на 2 года.", "0")
Return

:?:/ук7.3::
SendPlay {Enter}
SendChat("say 7.3 УК: Вымогательство, то есть требование передачи чужого имущества под угрозой применения насилия, уничтожения имущества,...", "0")
SendChat("say ...распространения позорящих сведений. Арест сроком на 3 года.", "500")
Return

:?:/ук7.4::
SendPlay {Enter}
SendChat("say 7.4 УК: Умышленные уничтожение или повреждение чужого имущества, если эти деяния повлекли причинение значительного ущерба...", "0")
SendChat("say ...Штраф - 50.000 рублей и возмещение ущерба или арест сроком на 2 года.", "500")
Return

:?:/ук7.5::
SendPlay {Enter}
SendChat("say 7.5 УК: Организация, проведение азартных игр в любой форме в общественных местах. Штраф - 50.000 рублей или арест сроком на 2 года.", "0")
Return
    ...
    SendChat("me заполни" lla " преступления, совершенного гражданином", "2500")
    ...
    If(Special){
        ...
        SendChat("do Рация Эрика-360 П45 закреплена на нагрудном кармане.", "5")
